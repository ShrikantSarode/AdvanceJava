...
public class CricketTeam {
	...
	public CricketTeam(String teamId, String teamName, int testRanking, int odiRanking, int t20Ranking) {
		super();
		this.teamId = teamId;
	...
	public String toString() {
		return "CricketTeam [teamId=" + teamId + ", teamName=" + teamName + ", testRanking=" + testRanking
				+ ", odiRanking=" + odiRanking + ", t20Ranking=" + t20Ranking + "]";
	}
