...
public class SpringSimpleExample {
	...
	public static void main(String[] args) {
		...
		String filePath = "./src/main/resources/springConfig.xml";
...
//		 WelcomeService gs = (WelcomeService) loadedObject;
		 ...
		 * are the components but 'gs' is obtained through Spring's environment
		 * where 'gs2' is not.
		 * Therefore 'gs' become a Managed Component and 'gs2' is an
		 * Unmanaged Component. 
		 */
